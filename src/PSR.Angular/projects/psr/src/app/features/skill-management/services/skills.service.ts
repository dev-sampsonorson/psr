...
export class SkillsService {
    ...
    public getCategory(id: string): Observable<ISkill> {
        return this.http.get<ISkill>(SkillMgtEndpoints.GetSkillCategory(this.appConfig, id)).pipe(
            // shareReplay()
        );
    }

    public getSubcategory(id: string): Observable<ISkill> {
        return this.http.get<ISkill>(SkillMgtEndpoints.GetSkillSubcategory(this.appConfig, id)).pipe(
            // shareReplay()
        );
    }
